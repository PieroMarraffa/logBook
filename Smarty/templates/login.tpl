...
<div class="wrapper fadeInDown">
    <div id="formContent">
        ...
        <div class="fadeIn first" >
            <a href="/logBook/"> <img src="../immagini/logo_logbook_vertical.PNG" id="icon"/></a>
        </div>

        <!-- Login Form -->
        <form method="post" id="form_login" onsubmit="return convalidaPassword(this)" action="/logBook/Admin/checkAdminCredentials">
